    ...
    return `
      <div class="relative mb-12 md:mb-16">
        ...
        <div class="hidden md:flex items-start gap-8">
          ...
          <div class="flex-1">
            <div class="experience-card cursor-pointer bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300" data-experience-id="${experience.id}">
              <!-- Type Badge -->
        ...
        <div class="md:hidden flex items-start gap-4">
          ...
          <div class="flex-1 pb-8">
            <div class="experience-card cursor-pointer bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300" data-experience-id="${experience.id}">
              <!-- Type Badge -->
